...
if args.task == 'task_1_tumor_vs_normal':
    ...
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'CLAM_prepared'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'LR-x4_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict = {"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_010_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict = {"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_025_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict = {"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_050_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict = {"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_075_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict = {"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_100_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict = {"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'Recon_VAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'Recon_VQVAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_010_VQVAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_025_VQVAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_050_VQVAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_075_VQVAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path='dataset_csv/RCC.csv',
                            data_dir=os.path.join(args.data_root_dir, 'lambda_100_VQVAE_CLAM'),
                            shuffle=False, 
                            seed=args.seed, 
                            print_info=True,
                            label_dict={"kich":0, "kirc":1, "kirp":2},
